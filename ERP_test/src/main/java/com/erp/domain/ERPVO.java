...
public class ERPVO implements Serializable{
	...
	private String school_name;//필요없음
	private int skill_code;
	private String [] skill_codes; //필요없음
	public ERPVO(){}
	public ERPVO(int staff_no, String staff_name, int religion_code, String religion_name, String before_graduate_day,
			String after_graduate_day, String graduate_day, String jumin_no, int school_code, String school_name,
			int skill_code, String[] skill_codes) {
		super();
	...
	public String toString() {
		return "ERPVO [staff_no=" + staff_no + ", staff_name=" + staff_name + ", religion_code=" + religion_code
				...
				+ skill_code + ", skill_codes=" + Arrays.toString(skill_codes) + "]";
	}
